let cfSale = carsForSale
let cfRent = carsForRental

function allCarsInOne( cfs, cfr){
...
function loadTable() {
    ...
    if (tBody) {
        for (let index = 0; index < carsForRental.length; index++) {
            ...
            //     getTD(currentCar.Miles_perrs),
            //     getTD(currentCar.Displacem_Gallon, 0),
            //     getTD(currentCar.Cylindeent),
